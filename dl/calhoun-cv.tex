...
\usepackage{
    ...
    hyperref,
    ragged2e,
    times, % <- default safe `professional` font.
    url,
}
...
\newlength\dwidth
\setlength{\dwidth}{\widthof{2000\ --\ }-1em}
...
\setdescription{font=\normalfont,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=!,labelwidth=\dwidth,labelsep=1em}
